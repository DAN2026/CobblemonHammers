...
public abstract class BaseHammer extends DiggerItem {

    public BaseHammer(Tier tier, TagKey<Block> mineableBlocks, Properties properties) {
        super(tier, mineableBlocks, properties);
    }

    public static List<BlockPos> getDestroyableBlocks(int range, BlockPos initialBlockPos, ServerPlayer player) {
